export default function MoodBadge({ mood }: { mood: string }) {
  ...
  return (
    <div className="rounded-2xl border border-border/50 glass p-6 flex flex-col items-center animate-fade-in-up h-full shadow-xl shadow-primary/5" style={{ animationDelay: '0.2s' }}>
